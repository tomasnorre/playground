<?php  //[STAMP] efcd2c3df608b1de605e22a76ec10e5c
...
trait AcceptanceTesterActions
{
     ...
     * @see \Codeception\Module\WebDriver::seeCookie()
     */
    public function tryToSeeCookie($cookie, $params = []) {
     ...
     * @see \Codeception\Module\WebDriver::dontSeeCookie()
     */
    public function tryToDontSeeCookie($cookie, $params = []) {
     ...
     * @see \Codeception\Module\WebDriver::setCookie()
     */
    public function tryToSetCookie($cookie, $value, $params = [], $showDebug = true) {
     ...
     * @see \Codeception\Module\WebDriver::setCookie()
     */
    public function retrySetCookie($cookie, $value, $params = [], $showDebug = true) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\WebDriver::resetCookie()
     */
    public function tryToResetCookie($cookie, $params = []) {
     ...
     * @see \Codeception\Module\WebDriver::grabCookie()
     */
    public function retryGrabCookie($cookie, $params = []) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\WebDriver::executeJS()
     */
    public function tryToExecuteJS($script, $arguments = []) {
     ...
     * @see \Codeception\Module\WebDriver::executeJS()
     */
    public function retryExecuteJS($script, $arguments = []) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\WebDriver::executeAsyncJS()
     */
    public function tryToExecuteAsyncJS($script, $arguments = []) {
     ...
     * @see \Codeception\Module\WebDriver::executeAsyncJS()
     */
    public function retryExecuteAsyncJS($script, $arguments = []) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
